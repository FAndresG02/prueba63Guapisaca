...
a persistence unit "prueba63GuapisacaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "prueba63Guapisaca/pom.xml":
...
artifact ("prueba63Guapisaca.war") is already built. You can build
